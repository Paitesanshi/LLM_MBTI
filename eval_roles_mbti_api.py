...
# 分解键值对并填充结果
    ...
    # csv_file_path = 'pop20_results_api.csv'
    ...
    mbti_csv_file_path = 'pop20_results_desc_mbti_en.csv'
    ...
    acc_csv_file_path = 'pop20_results_desc_acc_en.csv'
